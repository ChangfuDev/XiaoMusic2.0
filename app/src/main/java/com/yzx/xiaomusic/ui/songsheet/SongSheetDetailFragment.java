...
public class SongSheetDetailFragment extends BaseMvpFragment<SongSheetDetailPresenter> {
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        songSheetInfo = (SongSheetInfo) arguments.getSerializable(KEY_INFO_SONG_SHEET);
    }
    ...
    protected void initView(LayoutInflater inflater, Bundle savedInstanceState) {
        ...
        //初始化上个页面传来的信息
        tvTitle.setText(songSheetInfo.getTitle());
        tvName.setText(songSheetInfo.getTitle());
        GlideUtils.loadImg(getContext(), songSheetInfo.getCoverUrl(), GlideUtils.TYPE_TRANSFORM_BLUR, ivBg);
        GlideUtils.loadImg(getContext(), songSheetInfo.getCoverUrl(), ivLittleBg);
    ...
    protected void lazyLoadData() {
        ...
        loadService = LoadSir
                .getDefault()
                .register(recyclerView, (Callback.OnReloadListener) v -> mPresenter.getSongSheetDetail(songSheetInfo.getId()));
        mPresenter.getSongSheetDetail(songSheetInfo.getId());
    }
    ...
    public void setData(SongSheetDetail songSheetDetail) {
        ...
        tvSubTitle.setVisibility(TextUtils.isEmpty(result.getDescription()) ? View.GONE : View.VISIBLE);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_little_bg:
                arguments.clear();
                arguments.putSerializable(KEY_INFO_SONG_SHEET, result);
                easyStart(new SongSheetMoreFragment(), arguments);
                break;
        }
    }
}
