...
import com.yzx.xiaomusic.widget.video.BaseVideoFragment;
 ...
 * Description
 */
public class MvDetailFragment extends BaseVideoFragment<StandardVideoPlayer, MvDetailsPresenter> {
    ...
    protected void initView(LayoutInflater inflater, Bundle savedInstanceState) {
        ...
        mvId = arguments.getString(KEY_ID);
