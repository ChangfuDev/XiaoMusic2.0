...
public class MediaSessionManager {
    ...
    private static final String TAG = "yglMediaSessionManager";
    private final MusicService playService;
    private MediaSessionCompat mediaSessionCompat;


    public MediaSessionManager(MusicService playService) {
    ...
    public void updatePlaybackState() {
        ...
        mediaSessionCompat.setPlaybackState(
                new PlaybackStateCompat.Builder()
                        ...
                        .setState(state, playService.getMediaPlayer().getCurrentPosition(), 1)
                        .build());
    }
...
////            metaData.putLong(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS, AppCache.download().getMusicList().size());
////        }
//
