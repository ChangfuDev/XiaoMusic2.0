...
public class MusicFooter extends RelativeLayout implements RefreshFooter {
    ...
    private AnimationDrawable progressViewBackground;
    ...
    public MusicFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public MusicFooter(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        setBackgroundResource(com.yzx.xiaomusic.R.color.colorSubTitle);
        ...
        LayoutParams lpProgress = new LayoutParams(density.dip2px(15), density.dip2px(15));
        lpProgress.addRule(CENTER_VERTICAL);
        lpProgress.addRule(LEFT_OF, android.R.id.widget_frame);
        mProgressView = new ImageView(context);
        mProgressView.setBackgroundResource(com.yzx.xiaomusic.R.drawable.loading);
        mProgressView.setBackgroundTintList(getResources().getColorStateList(com.yzx.xiaomusic.R.color.colorAccent));
...
//                    mProgressView.animate().rotation(36000).setDuration(100000);
                    progressViewBackground = (AnimationDrawable) mProgressView.getBackground();
                    progressViewBackground.start();
                }
            }
        }
    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        if (!mNoMoreData) {
            if (mProgressDrawable != null) {
                ...
                if (progressViewBackground.isRunning()) {
                    progressViewBackground.stop();
                }
            }
            mProgressView.setVisibility(GONE);
            if (success) {
...
//                    replaceRefreshLayoutBackground(refreshLayout);
    ...
    public MusicFooter setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public MusicFooter setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public MusicFooter setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public MusicFooter setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public MusicFooter setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public MusicFooter setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public MusicFooter setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public MusicFooter setAccentColor(@ColorInt int accentColor) {
    ...
    public MusicFooter setPrimaryColor(@ColorInt int primaryColor) {
    ...
    public MusicFooter setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MusicFooter setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public MusicFooter setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public MusicFooter setTextSizeTitle(float size) {
    ...
    public MusicFooter setTextSizeTitle(int unit, float size) {
    ...
    public MusicFooter setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public MusicFooter setDrawableMarginRightPx(int px) {
    ...
    public MusicFooter setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public MusicFooter setDrawableSizePx(int px) {
    ...
    public MusicFooter setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public MusicFooter setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public MusicFooter setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public MusicFooter setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
