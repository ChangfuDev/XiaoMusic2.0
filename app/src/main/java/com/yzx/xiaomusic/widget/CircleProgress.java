...
public class CircleProgress extends View {
    ...
    public static final int GRAY = ResourceUtils.parseColor(MusicApplication.getContext(), R.color.colorIcon);
    public static final int LIGHT_GRAY = ResourceUtils.parseColor(MusicApplication.getContext(), R.color.colorIcon);
    public static final int COLOR_PLAY = ResourceUtils.parseColor(MusicApplication.getContext(), R.color.colorAccent);
