...
import static com.yzx.xiaomusic.Constant.PATH_ABSOLUTE_CACHE;
import static com.yzx.xiaomusic.Constant.PATH_ABSOLUTE_CACHE_IMG;
...
public class CacheManager {
    ...
    private void initDirectory() {
        ...
        //缓存目录
        File cacheDir = new File(PATH_ABSOLUTE_CACHE);
        if (!cacheDir.exists()) {
            cacheDir.mkdirs();
        }
    }
    ...
    private void initMusicCache() {
        File musicCacheDir = new File(PATH_ABSOLUTE_CACHE_MUSIC);
        if (!musicCacheDir.exists()) {
            musicCacheDir.mkdirs();
        }

        File imgCacheDir = new File(PATH_ABSOLUTE_CACHE_IMG);
        if (!imgCacheDir.exists()) {
            imgCacheDir.mkdirs();
        }
        File lyricCacheDir = new File(PATH_ABSOLUTE_CACHE_LYRIC);
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "initMusicCacheFail: " + e.toString());
        }
    }
